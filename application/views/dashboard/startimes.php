...
<div class="col mt-3">
                                	<!--Form-->
                 					<h2 class="mb-3">Pay  StarTimes Subscription<span style="font-weight: 400"> 
									- Instant Activation</span></h2>                         <?= form_open(); ?>                                            
		                         
		                            <div class="form-group">
		                                <label for="city">Startimes Subscription</label>
		                                <select name="cboCableTV" id="cboCableTV" onchange="GetAmount();" onmouseup="GetAmount()" onmousedown="GetAmount()" class="form-control">		<option> -- Select one -- </option>
		                                		<option value="startimes">Startimes                                  
		                                </select>
		                            </div>
		                            <div class="form-group">
		                            ...
		                            <div class="form-group">
		                                ...
		                                <textarea name="iuc in-md" id="iuc" class="form-control input-md in-md"></textarea>
   ...
   <div  id="lblSmartCardNo" name="lblSmartCardNo"></div>	
		                          ...
		                          <input type="text" name="txtAmount" id="txtAmount" value="" class="form-control input-md" readonly="true">
		                            ...
		                            <div class="form-group">
		                                ...
		                                <img name="imgLoader" id="imgLoader" style="visibility: hidden;" src="images/loader.gif" width="25" height="25">
		                               	<button type="submit" class="btn btn-primary btn-block" name="cmdSubmit" id="cmdSubmit" value="Click to Proceed" onclick="this.style.visibility='hidden';document.getElementById('imgLoader').style.visibility='visible';return validateForm1();">Pay Now</button>
		                            </div>		
		                            </form>
									<!--/Form-->
		                            <div class="row">
...
<script type="text/javascript">					
	document.getElementById('lblSmartCardNo').innerHTML='';					
</script>
<script>
       $(document).ready(function(){
            ...
            $('#iuc').change(function(){
               var id=$(this).val();
                $.ajax({
                    url : "<?= base_url();?>dashboard/verifystartimes",
                    method: "POST",
                    data : {id: id},
                    beforeSend: function(){
    ...
    $("#loader").show();
                    ...
                    success: function(data){
                        ...
                        var i;
                            ...
                            html += '<option class="" style="color:blue;margin-bottom:5px;font-weight:900" value='+data+'>'+data+'</option>';
            $('#lblSmartCardNo').empty();
                        
                        $('#lblSmartCardNo').html(html);
},
